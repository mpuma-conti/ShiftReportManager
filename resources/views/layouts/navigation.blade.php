<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-cyan" id="sidenavAccordion">
            ...
            <button class="btn btn-icon btn-transparent-dark btn-lg order-1 order-lg-0 me-2 ms-lg-2 me-lg-0" id="sidebarToggle"><i data-feather="menu"></i></button>
            <!-- Navbar Brand-->
            ...
            <ul class="navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications">
                    <a class="btn btn-icon btn-transparent-dark" href="https://outlook.office.com" target="_blank" role="button"><i data-feather="mail"></i></a>
                </li>
                <!-- User Dropdown-->
                    ...
                    <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        <h6 class="dropdown-header d-flex align-items-center">
                            ...
                            <div class="dropdown-user-details">
                                ...
                                <div class="dropdown-user-details-email"><a href="" class="__cf_email__" data-cfemail="7d0b1108131c3d1c1211531e1210">[email&#160;protected]</a></div>
                            </div>
                        </h6>
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <div class="sidenav-menu-heading">Supervisión</div>
                            ...
                            <div class="sidenav-menu-heading">Bitácoras</div>
                            <!-- Sidenav Accordion (Pages)-->
                            <x-responsive-nav-link :href="route('nuevo-reporte.index')" :active="request()->routeIs('nuevo-reporte.index')">
                            ...
                            <div class="collapse" id="collapseFlows" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav">
                                    <a class="nav-link" href="javascript:void(0);">Motores</a>
                            ...
                            <a class="nav-link" href="{{route('motores.index')}}"><div class="nav-link-icon"><i data-feather="shuffle"></i></div> Lista de standby's</a>
                            <a class="nav-link" href="javascript:void(0);"><div class="nav-link-icon"><i data-feather="radio"></i></div> Análisis vibracional</a>
                    ...
                    <div class="sidenav-footer">
                        <div class="sidenav-footer-content">
                            <div class="sidenav-footer-subtitle">Departamento de Mantenimiento</div>
